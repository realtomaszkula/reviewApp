...
Seat 6: reppinR1 folded on the River`;
            ...
            for (let i = 0; i < 10000; i++) {
                let x = new app_1.default({ hh: hhraw, options: opts });
            }
    ...
    describe('setStakes', () => {
        ...
        it('should create stakes object with correct properties', () => {
            ...
            hh = new app_1.default({ hh: hhraw, options: { setStakes: true } });
    ...
    describe('setHeroName', () => {
        ...
        describe('when setting hero name', () => {
            it('should capture names with alphanumeric characters', () => {
                ...
                hh = new app_1.default({ hh: hhraw, options: { setHeroName: true } });
    ...
    describe('setHeroCards', () => {
        describe('when setting hero cards', () => {
            describe('when dealt two cards', () => {
                ...
                beforeEach(() => {
                    let hhraw = `Dealt to reppinR1 [Js 8c]`;
                    hh = new app_1.default({ hh: hhraw, options: { setHeroCards: true } });
                });
    ...
    describe('setPot', () => {
        ...
        Board [7c 9h Ks]`;
                let hh = new app_1.default({ hh: hhraw, options: { setPot: true } });
...
Dealt to reppinR1 [3s 9c Ac Td]`;
                hh = new app_1.default({ hh: hhraw, options: { setHeroName: true, setPlayers: true, setHeroPosition: true } });
            });
