...
*** HOLE CARDS ***
  Dealt to reppinR1 [3s 9c Ac Td]`
     ...
     describe('when setting players stack sizes', () => {
       let hh;
       beforeEach( () => {
        let hhraw = `PokerStars Hand #156700709632:  Omaha Pot Limit ($0.50/$1.00 USD) - 2016/08/01 0:00:04 CET [2016/07/31 18:00:04 ET]
Table 'Aletheia' 6-max Seat #1 is the button
...
*** HOLE CARDS ***
  Dealt to reppinR1 [3s 9c Ac Td]`
      ...
      it('should should set stacksize for first player', () => {     
        expect(hh.players[0].stack).toEqual(149.08);
      });
      it('should should set stacksize for second player', () => {     
        expect(hh.players[1].stack).toEqual(117.77);
      });
      it('should should set stacksize for third player', () => {     
        expect(hh.players[2].stack).toEqual(100);
      });
      it('should should set stacksize for fourth player', () => {     
        expect(hh.players[3].stack).toEqual(27.49);
      });
      it('should should set stacksize for fith player', () => {     
        expect(hh.players[4].stack).toEqual(107.49);
      });
      it('should should set stacksize for sixth player', () => {     
        expect(hh.players[5].stack).toEqual(246.97);
      });
